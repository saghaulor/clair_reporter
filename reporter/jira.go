...
func init() {
	...
	registerMaker("jira", Maker{
		RegisterFlags: func() {
			...
			fieldsConfiguration = flag.String("JIRA_FIELDS", "Project|CD;Issue Type|Story;Summary|Test Container Security Vulnerability: container name:{{ .failure.Repo }}, package name:{{ .failure.Package }};Description|{{ .failure.Description }};Component/s|Platform Security;Dev Team|{{ .failure.DevTeam }};Priority|P2;Severity|Sev-2;Vulnerability Report By|Clair;Labels|security_infrastructure", "JIRA fields in 'key|value;...' format seperated by ';', this configuration MUST contain 'Project', 'Summary' and 'Issue Type'")
